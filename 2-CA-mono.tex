...
Calculamos la tensión en circuito abierto, planteando las siguientes
ecuaciones:
...
Para calcular la impedancia apagamos las fuentes independientes y
conectamos un generador de prueba en AB:

\begin{minipage}{0.5\linewidth}
  \includegraphics[width=.9\linewidth]{figuras/thevenin6_fuenteprueba.pdf}
\end{minipage}
\begin{minipage}{0.5\linewidth}
  \begin{align*}
