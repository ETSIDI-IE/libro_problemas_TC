...
\begin{center}
  FIGURA
  %%\includegraphics[height=0.3\textheight]{figuras/Esquema.pdf}
\end{center}
...
\begin{center}
  FIGURA
  %\includegraphics[width = 0.9\textwidth]{figuras/trifasica}
\end{center}
...
\begin{center}
  FIGURA
  %\includegraphics[scale=0.4]{figuras/FiguraBT3.pdf}
\end{center}
