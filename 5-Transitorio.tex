...
\begin{minipage}{0.4\linewidth}
  \center{\includegraphics[scale=0.7]{figuras/BT4_CondicionesIniciales_bobcon0+.pdf}}
\end{minipage}
\smallskip
...
\begin{center}
  \includegraphics{figuras/HKD84_natural}
\end{center}
...
\begin{align*}
  ...
  \diff{u_C(t)}{t}[t = 0^+] &= [-e^{-t} \cdot (2\cos(\sqrt{3}t) + B_2\sin(\sqrt{3}t)) +\\
           &+ e^{-t} \cdot (-2\sqrt{3}\sin(\sqrt{3}t) + \sqrt{3} B_2\cos(\sqrt{3}t))]_{t = 0^+}=\\
           &= 0
\end{align*}
...
\item Condiciones iniciales
  ...
  Finalmente, $i_c(0^+) = i_L(0^+) = \SI{1}{\ampere}$.
